...
export const timeline: TimelineItem[] = [
    // === EXPERIENCIA PROFESIONAL ===
    {
        ...
        tags: ['Angular', 'Node.js', 'PostgreSQL', 'Salesforce', 'Clean Architecture', 'REST APIs'],
    ...
    },
    {
        ...
        tags: ['Angular', 'Node.js', 'TypeScript', 'SCSS', 'Firebase', 'Diseño responsivo'],
        icon: 'fa fa-briefcase',
    },
    {
        type: 'work',
        ...
        tags: ['Moodle', 'Canva Pro', 'Diseño instruccional', 'E-learning'],
        icon: 'fa fa-briefcase',
    },
    {
        type: 'work',
        ...
        tags: ['Angular', '.NET Core', 'MySQL', 'MVC', 'Repository Pattern', 'Autenticación'],
        icon: 'fa fa-briefcase',
    },
    ...
    // === CERTIFICACIONES ===
    {
        ...
        tags: ['Python', 'Cisco', 'Programación básica'],
        icon: 'fa fa-trophy',
    },
    {
        type: 'cert',
        ...
        tags: ['Data Science', 'Python', 'Análisis', 'Visualización'],
        icon: 'fa fa-trophy',
    },
    {
        type: 'cert',
        ...
        tags: ['Cloud', 'AWS', 'Google Cloud', 'Infraestructura'],
        icon: 'fa fa-trophy',
    },
    {
        type: 'cert',
        ...
        tags: ['IA', 'Machine Learning', 'Data', 'Automatización'],
        icon: 'fa fa-trophy',
    },
    ...
    // === FORMACIÓN ACADÉMICA ===
    {
        ...
        tags: ['Desarrollo de software', 'Arquitectura', 'Bases de datos', 'Gestión de proyectos'],
    ...
    },
    {
        ...
        tags: ['Educación media', 'Bachillerato técnico'],
        icon: 'fa fa-graduation-cap',
    },
];